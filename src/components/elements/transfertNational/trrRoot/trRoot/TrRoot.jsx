...
import TypeTransfertRoot from './cases/TypeTransfertRoot';
...
const TrRoot = () => {
  ...
  const handleTypeButtonClick = (type) => {
   ...
   const handleOrdonnateurButtonClick = (infos) => {
    ...
    console.log("ordonnateur :",ordonnateur);
  };
  ...
  const renderForm = () => {
    switch (currentStep) {
      case 0:
        return (
          <TypeTransfertRoot onTypeButtonClick={handleTypeButtonClick} />
        );
      case 1:
        return (
      ...
      case 2:
        return (
          <Dest onDestButtonClick={handleDestButtonClick} idOrdonnateur={ordonnateur.customer.id} destinationsBackClicked={destinationsBackClicked} destinationsBack={destinations} />
        );
      case 3:
        return (
            ...
            <Stack>
              ...
              <Stack mt={4}>
                ...
                <Button
                  ...
                  isDisabled={currentStep >= 4 || !typeSelected}
                >
                  <Flex direction="column" alignItems="center">
