...
//   const handleSummaryButtonClick = (infos) => {
//     setSummarySelected(true);
//     handleButtonClick(4);
//     setTransferID(infos);
//   };
...
//       case 4:
//         return (
//           <Recu onRecuButtonClick={handleRecuButtonClick} transferID={transferID}/>
//         );
//       default:
//         return <Congrats/>;
//     }
...
//                     textAlign="center"
//                     onClick={() => handleButtonClick(2)}
//                     isDisabled={!ordonnateurSelected}
//                   >
//                     <Flex direction="column" alignItems="center">
//                       <Text fontSize={{ base: 'xs', md: 'lg' }}>Bénéficiaire(s)</Text>
//                       <Icon as={GoGoal} boxSize={{ base: 4, md: 10 }} mt={{ base: 1, md: 2 }} />
